...
<body>
    ...
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="main/seeblogtype.jsp">查看博客类别信息</a></li>
    </ul>
    </div>
    
     
    <form action="UserServlet" method="post" name="seeblogtype">
    <div class="formbody">
    <div class="formtitle"><span>查看博客类别</span></div> 
    <input type="hidden" name="action" value="seeblogtype"></input> 
    <table border="1">
      <tr>
      <th>编号 </th> 
      <th>博客类型</th>
...
<script language=javascript>
    //setTimeout("document.seeblogtype.submit()",1000);
</script>