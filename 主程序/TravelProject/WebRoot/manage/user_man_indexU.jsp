...
<body>
    ...
    <ul class="forminfo">
				<li><label>用户名：</label>
				<input name="username" type="text" class="dfinput" id="name" />
				</li>
				<li><label>新密码：</label><input name="password" type="password"
					class="dfinput" id="newpwd" />
				</li>
				<li><label>确认密码：</label><input name=" " type="password"
					class="dfinput" id="cnpwd" />
				</li>
				<li><label>&nbsp;</label><input name="" type="submit"
					class="loginbtn" value="确定修改" id="fm" />
				</li>
			</ul>
     </form>
    </div>
